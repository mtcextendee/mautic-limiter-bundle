...
JS;
    ...
    mQuery('form .box-layout').html('<div class="row"><div class="alert alert-warning col-md-6 col-md-offset-3 mt-md" style="white-space: normal;"><p>{$this->limiterSettings->getMessage(
        )}</p></div></div>');
       };
        }
